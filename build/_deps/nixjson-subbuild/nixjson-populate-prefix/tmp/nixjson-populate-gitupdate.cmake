...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "developer"
  WORKING_DIRECTORY "/workspaces/JogoDePerguntas/build/_deps/nixjson-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("developer" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/developer")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"developer\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/JogoDePerguntas/build/_deps/nixjson-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/JogoDePerguntas/build/_deps/nixjson-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
